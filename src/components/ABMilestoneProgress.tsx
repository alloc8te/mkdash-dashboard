...
import type { ABMilestoneCompletion } from '@/lib/types';

interface Props {
  milestones: ABMilestoneCompletion[];
  ...
  return (
    <div className="radial-gauge" style={{ width: size, height: size }}>
      <svg width={size} height={size}>
        ...
        />
        <defs>
          <linearGradient id="abGaugeGradient" x1="0%" y1="0%" x2="100%" y2="0%">
...
export default function ABMilestoneProgress({ milestones, cumulativeCompletion }: Props) {
  return (
    <div className="milestone-progress-wrapper">
      ...
      >
        {milestones.map((m, index) => (
          <div className="milestone-item" key={m.milestoneId} style={{ gap: '0.4rem' }}>
            <div
            ...
            <div className="milestone-bar">
              <div className="progress-bar-bg">
                <div
                  ...
                  style={{
                    width: `${Math.round(m.completionPct * 100)}%`,
